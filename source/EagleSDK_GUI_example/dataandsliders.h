  ...
  public:
    ...
    */
    void initiate(){
      ...
      tracking_slider.add("My data changes as you <b>drag</b> me!", y_anchor + 2, x_anchor, 2, 21, 0, 100, 0, 1, FlexSlider::ALLOW_INPUT);  //arguments are display name, row, column, row span, column span, minimum slider value, maximum slider value, initial slider value, implied denominator, configuration setting    //or   Watch_how_my_data_changes!  ??
