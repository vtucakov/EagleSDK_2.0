/**
  ...
  @version 1.0
  @brief GUI page
  Copyright Iris Dynamics LTD. All Rights Reserved
  trademark stuff
*/
  ...
  public:
    ...
    */
    void initiate() {
      ...
      addition_button.add("Add", -1, y_anchor + 15, x_anchor + 25, 1, 4);
      subtraction_button.add("Subtract", -1, y_anchor + 17, x_anchor + 25, 1, 4);
      scatter_value.add("Value ", y_anchor + 16, x_anchor + 30, 1, 7, 0, 1);  //note that if none of the config options are needed (config param = 0), then no configuration paramtere should be passed
      change_plot_colour.add("Change Plot Colour", 0, y_anchor + 15, x_anchor + 18, 3, 5);
